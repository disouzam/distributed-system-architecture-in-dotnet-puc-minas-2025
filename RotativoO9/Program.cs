...
namespace RotativoO9
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddTransient<ICadastroUseCase, CadastroUseCase>();
            builder.Services.AddTransient<ICadastroRepository, CadastroRepository>();
            builder.Services.AddTransient<IWorkInProgress, WorkInProgress.WorkInProgress>();
